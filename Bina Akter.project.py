...
# Buttons
Button(root, text="Encrypt", command=encrypt_message, bg="#FFF5EE", font=("Helvetica", 12)).pack(pady=10)  # Seashell
Button(root, text="Decrypt", command=decrypt_message, bg="#F5F5DC", font=("Helvetica", 12)).pack(pady=10)  # Beige
